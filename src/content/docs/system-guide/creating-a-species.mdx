...
**Founding pair (Mother and Father):** every species is seeded with two original ancestors.

- **Truebred and Composition hybrid:** you name a Mother and a Father who become the species' fresh root lineage.
...
<a id="8-rules--tips-at-a-glance"></a>
