...
The optional AI role-play companion can narrate freeform scenes, offer choices, and react like a live game master. It complements the standard menu-driven experience described in [Interaction and role-play lifecycle](/system-guide/interaction-and-roleplay).
