---
title: "Reproduction and genetics lifecycle"
...
## Hand a birth to a new player

Once a birth is ready, you can offer it to a nearby person who has no active character. They can accept or decline becoming that child.

Accepting makes the child their active character, with its inherited traits and the birth parent's pack membership when applicable. Declining or letting the offer expire leaves the birth unclaimed for later.

See [Packs](/getting-started/packs#packs-and-new-births) for inherited pack roles.
