...
- A **companion web dashboard** for managing your character and settings outside the world, and a separate **web portal** for linking optional services.
...
- The core gameplay loop → [Interaction and role-play lifecycle](/system-guide/interaction-and-roleplay)
- The reproductive life-cycle → [Reproduction and genetics lifecycle](/system-guide/reproduction-and-genetics)
...
- Consumable items and attachable devices → [Attachable items and devices](/system-guide/attachable-items-and-devices)

- Accounts and relationships → [Accounts and profiles](/system-guide/accounts-and-profiles), [Packs](/getting-started/packs)
- Character health and recovery → [Vitality and stats](/system-guide/vitality-and-stats)
- Narrated scenes → [AI role-play companion](/system-guide/ai-companion)
- Finding players and places → [Search and discovery](/system-guide/search-and-discovery)
- Browser views → [Companion web dashboard](/system-guide/companion-dashboard), [Web portal](/system-guide/web-portal)
- Optional connections → [Third-party integrations and product compatibility](/system-guide/third-party-integrations)
- Purchases and rewards → [AnE Store](/getting-started/operation/ane-store)
- Appearance and shortcuts → [RLV Outfits](/optional-add-ons/rlv-outfits), [Command Line](/getting-started/command-line)
- Getting help → [Help and support](/overview/help-and-support)
