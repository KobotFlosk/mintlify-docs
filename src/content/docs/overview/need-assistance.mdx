...
description: "Read the AnE guide to ⁉️ Need Assistance?."
---
...
Open **Help** on the main menu for the manual, community links, updates, tutorials, and language settings. See [Help and support](/overview/help-and-support) for each option.
