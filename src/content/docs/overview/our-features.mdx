---
title: "✨ Our Features"
description: "Read the AnE guide to ✨ Our Features."
---

## Features

* **Genders:** Supports all genders (Males, Females, Hermaphrodites, Andromorphs, Gynomorphs).
* **Breeding Gardens:** Find community-registered breeding locations through [Search and discovery](/system-guide/search-and-discovery).
