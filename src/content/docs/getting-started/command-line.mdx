---
title: "Command Line"
description: "Read the AnE guide to Command Line."
---
...
## Built-in help and other shortcuts

Chat commands complement the menus; you do not need them for everyday play. Some commands accept a toggle, while others take free text such as an outfit name or away message.

Use **help** followed by a topic to get reminders about available features, profile-description tags, or shared folders. Other shortcuts let you check your Credit balance or change whether you are speaking out of character. Administrative commands require special permissions and are not available to regular accounts.
