---
title: "Breeding (legacy)"
description: "Read the AnE guide to Breeding (legacy)."
---

import { Aside } from '@astrojs/starlight/components';

Breeding can be engaged from either using the region [search ](/getting-started/operation)or the quick breed button to find others nearby. 
...
![](/images/gitbook/MdHDaTm5mejqgaY7jGM4.png)
